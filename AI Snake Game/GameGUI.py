...
class GameGUI:
    def __init__(self):
        ...
        self.font_name = 'aAbstractGroovy.ttf'
    ...
    def draw_elements(self):
        ...
        if self.curr_menu.state != '' or self.controller.model_loaded:  # Path Ai or trained GA
    ...
    def game_over(self):
        ...
        while not again:
            ...
            if self.curr_menu.state == '' and self.controller.model_loaded == False:
                best_score = self.controller
                best_gen = self.controller
    ...
    def event_handler(self):
        for event in pygame.event.get():
            ...
            # user event that runs every self.speed milisec
                ...
                elif event.key == pygame.K_w:  # speed up/down by +_up
